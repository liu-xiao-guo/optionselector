...
UBUNTU_TRANSLATION_DOMAIN="optionselector.liu-xiao-guo"
...
aptest.commands = bash $$PWD/optionselector/tests/autopilot/run
aptest.depends  = sub-optionselector

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/optionselector/tests/unit
unittest.depends  = sub-optionselector
